...
\begin{table}[H]
    \begin{center}
        \begin{tabular}{|l|l|}
            ...
            \hline
            \texttt{DoAnController}            & Danh sách dịch vụ bắp nước/combo \\
            \hline
            ...
            \hline
            \texttt{Admin/DoAnController}      & Quản trị dịch vụ: CRUD \\
            \hline
...
\begin{table}[H]
    \begin{center}
        \begin{tabular}{|l|l|}
            ...
            \hline
            \texttt{IDoAnBUS / DoAnBUS}       & Lấy danh sách dịch vụ theo ID \\
            \hline
        \end{tabular}
    \end{center}
...
\begin{table}[H]
    \begin{center}
        \begin{tabular}{|l|l|}
            ...
            \hline
            \texttt{DoAnChonDTO}      & Dịch vụ người dùng chọn (MaDV, SoLuong, DonGia) \\
            \hline
...
\begin{itemize}
    ...
    \item \textbf{Công nghệ \& Tối ưu:} Tích hợp \textbf{IMemoryCache} để tăng tốc load danh sách phim, xuất báo cáo ra file Excel với thư viện \textbf{ClosedXML}, kiểm thử mã nguồn với \textbf{xUnit và Moq} (hoàn thành 20 Unit Tests bao phủ toàn diện tầng BUS).
