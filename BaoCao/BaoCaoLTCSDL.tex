...
\noindent{\textbf{Từ khóa:}} ASP.NET Core MVC, Entity Framework Core, SQL Server T-SQL, ADO.NET, LINQ, LINQ to XML, RESTful Web API, Kiến trúc 3 lớp, Quản lý rạp phim, xUnit, BCrypt, VNPay, Google OAuth 2.0.
...
\begin{itemize}
    \item \textbf{Khách hàng:} Đăng ký, \textbf{đăng nhập bằng Google}, duyệt danh sách phim (tốc độ cao nhờ Caching), chọn suất chiếu, chọn ghế, thêm dịch vụ, \textbf{thanh toán qua ví điện tử VNPay} và nhận E-Ticket có mã QR. Sau khi đăng nhập, người dùng có thể cập nhật Profile và đổi mật khẩu.
...
\begin{itemize}
    ...
    \item \textbf{Tính năng người dùng:} \textbf{Đăng nhập một chạm bằng Google OAuth 2.0}, đặt vé với hệ thống phòng chiếu \textbf{sinh sơ đồ ghế động}, \textbf{thanh toán trực tuyến bằng cổng VNPay Sandbox}, E-Ticket có mã QR.
...
\begin{itemize}
    \item Áp dụng \textbf{SignalR} để đồng bộ hóa việc đặt ghế theo thời gian thực (tránh trùng ghế khi nhiều người mua cùng lúc).
